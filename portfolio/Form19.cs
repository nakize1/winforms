...
namespace portfolio
{
    public partial class Form19 : Form
    {
        ...
        private void back19_Click(object sender, EventArgs e)
        {
            if (main != null) main.SwitchToForm(new Form1());
            else { var f1 = new Form1(); f1.Show(); this.Hide(); }
        }

        private void info19_Click(object sender, EventArgs e)
        {
            if (main != null) main.SwitchToForm(new Form17());
        }

        private void skills19_Click(object sender, EventArgs e)
        {
            if (main != null) main.SwitchToForm(new Form18());
        }

        private void educ19_Click(object sender, EventArgs e)
        {
            if (main != null) main.SwitchToForm(new Form19());
        }

        private void hobbies19_Click(object sender, EventArgs e)
        {
            if (main != null) main.SwitchToForm(new Form20());
        }

        private void msg19_Click(object sender, EventArgs e)
        {
